...
def rdf_to_puml(input_rdf, save_puml = False, output_puml=None, layout_type='spring', layout_params=None, 
...
def axiom_to_puml(class_entity, ontology, type: int, save_puml = False):
    axiom_result = AxiomToPumlConverter(class_entity, ontology, type).convert()
